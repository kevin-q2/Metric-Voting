...
input_file = 'metric_voting/data/4bloc_10k_5cand.npz'

# And where to save them!
output_file1 = 'metric_voting/figures/4bloc_10k_5cand_representation.png'
output_file2 = 'metric_voting/figures/4bloc_10k_5cand_representation_overall.png'
...
ax = sns.boxplot(data=filtered_data[:,random_columns].T, palette = colors, width = 0.6, linewidth=2.5, fliersize= 1, flierprops=flierprops)
ax.set_ylim(0.9, 2)
...
ax = sns.boxplot(data=filtered_data_overall[:,random_columns].T, palette = colors, width = 0.6, linewidth=2.5, fliersize= 1, flierprops=flierprops)
ax.set_ylim(0.9, 2)
...
ax = sns.violinplot(data=filtered_data[:,random_columns].T, palette = colors, alpha = 1, width = 0.9)
...
ax = sns.violinplot(data=filtered_data_overall[:,random_columns].T, palette = colors, alpha = 1, width = 0.9)
for violin in ax.collections:
    violin.set_alpha(1)
