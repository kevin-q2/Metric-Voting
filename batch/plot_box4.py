...
input_file = 'metric_voting/data/4bloc.npz'

# And where to save them!
output_file1 = 'metric_voting/figures/4bloc_representation.png'
output_file2 = 'metric_voting/figures/4bloc_representation_overall.png'
