...
input_file = '../../data/square.npz'

# And where to save them!
output_file1 = '../../figures/square_representation.png'
output_file2 = '../../figures/square_representation_overall.png'
...
ax = sns.violinplot(data=filtered_data[:,random_columns].T, palette = colors, alpha = 1, width = 100)
...
ax = sns.violinplot(data=filtered_data_overall[:,random_columns].T, palette = colors, alpha = 1, width = 100)
for violin in ax.collections:
    violin.set_alpha(1)
