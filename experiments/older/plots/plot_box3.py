...
input_file = '../../data/2bloc_separated.npz'

# And where to save them!
output_file1 = '../../figures/2bloc_separated_representation.png'
output_file2 = '../../figures/2bloc_separated_representation_overall.png'
