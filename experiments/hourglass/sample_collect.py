...
elections_dict = {
    ...
    ChamberlinCourant:{'solver' : 'GUROBI_CMD', 'log_path' : 'experiments/hourglass/cc.log'},
    GreedyCC:{},
    Monroe:{'solver' : 'GUROBI_CMD', 'log_path' : 'experiments/hourglass/monroe.log'},
    GreedyMonroe:{}, 
    PAV:{'solver' : 'GUROBI_CMD', 'log_path' : 'experiments/hourglass/pav.log'},
    PluralityVeto:{},
    CommitteeVeto:{'q':k}, 
    ExpandingApprovals: {},
    SMRD:{},
