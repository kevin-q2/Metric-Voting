...
output_file = 'figures/two_bloc/thousand_voters/distribution_tiebreak.png'
...
f = 'data/two_bloc/thousand_voters/tiebreak/samples_chamberlin'
...
f = 'data/two_bloc/thousand_voters/tiebreak/samples_monroe'
